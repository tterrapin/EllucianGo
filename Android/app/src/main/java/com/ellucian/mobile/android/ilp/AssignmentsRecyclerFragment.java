...
public class AssignmentsRecyclerFragment extends EllucianDefaultRecyclerFragment implements
	...
	protected void showType(int type) {
	...
	public ArrayList<IlpItemHolder> buildAssignmentsList(Cursor cursor) {
	...
	public void buildAdapters(ArrayList<IlpItemHolder> assignmentsList) {
