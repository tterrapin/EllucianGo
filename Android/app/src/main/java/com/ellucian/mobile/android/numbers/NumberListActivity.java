...
public class NumberListActivity extends EllucianActivity implements LoaderManager.LoaderCallbacks<Cursor> {

	private static final String TAG = NumberListActivity.class.getSimpleName();
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		mainFragment =  (EllucianDefaultExpandableListFragment) manager.findFragmentByTag("NumberListFragment");
		
		if (mainFragment == null) {
			mainFragment = EllucianDefaultExpandableListFragment.newInstance(this, NumberListFragment.class.getName(), null);

			mainFragment.setListAdapter(adapter);
			transaction.add(R.id.frame_main, mainFragment, "NumberListFragment");
		} else {
			mainFragment.setListAdapter(adapter);
	...
	protected void onNewIntent(Intent intent) {
    	...
    	if ( !Intent.ACTION_SEARCH.equals(intent.getAction())  && 
    		...
    		Intent restartingIntent = new Intent(this, NumberListActivity.class);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
    	...
    	searchView.setOnCloseListener(new OnCloseListener() {
    		...
    		public boolean onClose() {
    			...
    			getLoaderManager().restartLoader(CATEGORY_LOADER, null, NumberListActivity.this);
    			query = null;
    	...
    	searchView.setOnClickListener(new SearchView.OnClickListener() {
    		...
    		public void onClick(View v) {
    			...
    			NumberListActivity.this.sendEventToTracker1(GoogleAnalyticsConstants.CATEGORY_UI_ACTION, GoogleAnalyticsConstants.ACTION_SEARCH, "Search", null, moduleName);
    		}
    	});
