...
- (void) fetchAssignments {
    ...
    NSString *urlString = [NSString stringWithFormat:@"%@/%@/%@/assignments", [self.module propertyForKey:@"ilp"], [[CurrentUser userid]  stringByAddingPercentEscapesUsingEncoding: NSUTF8StringEncoding], [self.sectionId stringByAddingPercentEscapesUsingEncoding: NSUTF8StringEncoding]];
